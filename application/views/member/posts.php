    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-xs-12 col-sm-12 col-lg-12" style="text-align:center;background:rgba(0,0,0,0.3);">
                <a href="<?php echo base_url('member/home') ?>"><div style="cursor:pointer;float:left;padding-left:1.5em;padding-top:1.5em"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-binoculars-fill" viewBox="0 0 16 16">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12 col-xs-12 col-sm-6 col-col-lg-6">
                            <div style="background:rgba(255,255,255,0.2);border-radius:10px;color:#fff;font-family: 'Nunito', sans-serif;">

                            <form method="post" action="<?=base_url('member/p_posts')?>">
                                <div class="container-fluid">
                                     <div class="row">
                                         ...
                                         <textarea name="posts_content" style="width:100%;text-align:center;background:rgba(255,255,255,0.3);color:white" placeholder="Please Insert"></textarea>
                                         <input type="submit" style="width:100%;border-radius:5px">
                                         </div>
                                     </div>
                                </div>
