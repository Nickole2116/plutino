    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div style="margin-top:1%;color:#d9d9d9;text-align:center;">
                <form method="post" action="<?= base_url('welcome/p_register')?>">
                    <small>Enter your new credentials</small><br>
                    <input type="text" name="txtusernamer" placeholder="New Username" style="font-size:12px;letter-spacing:0.3em;text-align:center;background: linear-gradient(to bottom, rgba(255, 250, 225, 0.2), rgba(255, 250, 225, 0.2));border:none;width:50%;border-radius:5px;padding:10px 10px;color:white" required>
                    <br><br>
                    <input type="password" name="txtpasswordr" placeholder="New Password" style="font-size:12px;letter-spacing:0.2em;text-align:center;background: linear-gradient(to bottom, rgba(255, 250, 225, 0.2), rgba(255, 250, 225, 0.2));border:none;width:50%;border-radius:5px;padding:10px 10px;color:white" required>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div style="margin-top:40%;color:#d9d9d9;text-align:center">
                <form method="post" action="<?= base_url('welcome/p_register_mb')?>">
                    <small>Enter your new credentials</small>
