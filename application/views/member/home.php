    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-xs-12 col-sm-12 col-lg-12" style="text-align:center;background:rgba(0,0,0,0.3);">
                ...
                <div style="cursor:pointer;float:right;padding-right:1.5em;padding-top:1.5em"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0v2z"/>
                    <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
                    </svg>&nbsp; <br><small>Logout</small>
                </div>
                <div style="padding:40px 20px;">
                    <span>Hello, nickole01 ( <b style="color:#ffd171">Ast. #5725</b> )</span>
                </div>
        ...
        <div class="row">
            ...
            <div class="navbar" style="cursor:pointer;overflow: hidden;position: fixed;bottom: 2em;right:2em;background:#f0f3ff;border-radius:30px;padding:15px"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black" class="bi bi-pen-fill" viewBox="0 0 16 16">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-xs-12 col-sm-6 col-col-lg-6">
                            <div style="background:rgba(255,255,255,0.8);border-radius:10px;color:#000;font-family: 'Nunito', sans-serif;">
                                <small>2020.01.29 | 12:55AM</small>
                                <div style="background:#d9d9d9;height:1.5px"></div>
                                <div style="font-family: 'Nunito', sans-serif;font-size:14px;padding:15px">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                 ...
                                 software like Aldus PageMaker including versions of Lorem Ipsum.<br><br><div style="font-family: 'Nunito', sans-serif;font-weight:600"><mark style="border-radius:13px;">&nbsp;From Astronaut #2116&nbsp;</mark></div></div>
        ...
        <div class="row">
            <div class="col-12 col-xs-12 col-sm-12 col-lg-12" style="text-align:center;background:rgba(0,0,0,0.3);">
                ...
                <div style="padding:30px 20px;">
                    <span style="font-size:14px">Hello, nickole01 <br><small>( <b style="color:#ffd171">Ast. #5725</b> )</small></span>
                </div>
